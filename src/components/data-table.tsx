...
const columns = columnHelper.columns([
  ...
  columnHelper.accessor("limit", {
    header: () => <div className="w-full text-right">Period</div>,
    cell: ({ row }) => (
      <form
        onSubmit={(e) => {
          e.preventDefault()
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select
          ...
          items={[
            ...
            { label: "Documents", value: "past-performance" },
            { label: "Tax Filings", value: "key-personnel" },
            { label: "MIS Reports", value: "focus-documents" },
          ]}
        >
          <SelectTrigger
          ...
          <SelectContent>
            <SelectGroup>
              ...
              <SelectItem value="past-performance">Documents</SelectItem>
              <SelectItem value="key-personnel">Tax Filings</SelectItem>
              <SelectItem value="focus-documents">MIS Reports</SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
        <TabsList className="hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:bg-muted-foreground/30 **:data-[slot=badge]:px-1 @4xl/main:flex">
          ...
          <TabsTrigger value="focus-documents">MIS Reports</TabsTrigger>
        </TabsList>
        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
          ...
          <form className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-3">
                <Label htmlFor="limit">Period</Label>
